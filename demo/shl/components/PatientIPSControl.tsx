...
// Section title header with checkbox
...
const SectionTitle: React.FC<SectionTitleProps> = ({ title, isSelected = true, onSelectionChange }) => (
  <Group align="center" gap="sm" bg="gray.1" p="sm">
    {onSelectionChange && (
      <Checkbox size="sm" checked={isSelected} onChange={(event) => onSelectionChange(event.currentTarget.checked)} />
    )}
...
// Responsive table wrapper using Mantine best practices
const ResponsiveTable: React.FC<{ minWidth?: number; children: React.ReactNode }> = ({ minWidth = 700, children }) => {
  return <Table.ScrollContainer minWidth={minWidth}>{children}</Table.ScrollContainer>;
};
...
const ProblemListSection: React.FC<{ conditions: any[] } & SectionProps> = ({
  ...
  return (
    <Box>
      <SectionTitle title="Problem List" isSelected={isSelected} onSelectionChange={onSelectionChange} />
...
const AllergiesSection: React.FC<{ allergies: any[] } & SectionProps> = ({
  ...
  return (
    <Box>
      <SectionTitle title="Allergies and Intolerances" isSelected={isSelected} onSelectionChange={onSelectionChange} />
...
const MedicationSummarySection: React.FC<{ medications: any[] } & SectionProps> = ({
  ...
  return (
    <Box>
      <SectionTitle title="Medication Summary" isSelected={isSelected} onSelectionChange={onSelectionChange} />
      <ResponsiveTable minWidth={800}>
        <Table>
          <Table.Tbody>
            <Table.Tr>
...
const ImmunizationsSection: React.FC<{ immunizations: any[] } & SectionProps> = ({
  ...
  return (
    <Box>
      <SectionTitle title="Immunizations" isSelected={isSelected} onSelectionChange={onSelectionChange} />
      <ResponsiveTable minWidth={600}>
        <Table>
          <Table.Tbody>
            <Table.Tr>
...
const ResultsSection: React.FC<{ labResults: any[] } & SectionProps> = ({
  ...
  return (
    <Box>
      <SectionTitle title="Results" isSelected={isSelected} onSelectionChange={onSelectionChange} />
...
const ProceduresSection: React.FC<{ procedures: any[] } & SectionProps> = ({
  ...
  return (
    <Box>
      <SectionTitle title="History of Procedures" isSelected={isSelected} onSelectionChange={onSelectionChange} />
      <ResponsiveTable minWidth={500}>
        <Table>
          <Table.Tbody>
            <Table.Tr>
              <Table.Td style={{ fontWeight: 'bold', minWidth: '200px' }}>Procedure</Table.Td>
              <Table.Td style={{ fontWeight: 'bold', width: '100px' }}>Performed</Table.Td>
            </Table.Tr>
...
const DeviceUseSection: React.FC<{ deviceUseStatements: any[]; devices: any[] } & SectionProps> = ({
  ...
  return (
    <Box>
      <SectionTitle title="Device Use" isSelected={isSelected} onSelectionChange={onSelectionChange} />
      <ResponsiveTable minWidth={900}>
        <Table>
          <Table.Tbody>
            <Table.Tr>
...
const VitalSignsSection: React.FC<{ vitalSigns: any[] } & SectionProps> = ({
  ...
  return (
    <Box>
      <SectionTitle title="Vital Signs" isSelected={isSelected} onSelectionChange={onSelectionChange} />
      <ResponsiveTable minWidth={900}>
        <Table>
          <Table.Tbody>
            <Table.Tr>
...
const SocialHistorySection: React.FC<{ socialHistory: any[] } & SectionProps> = ({
  ...
  return (
    <Box>
      <SectionTitle title="Social History" isSelected={isSelected} onSelectionChange={onSelectionChange} />
      <ResponsiveTable minWidth={900}>
        <Table>
          <Table.Tbody>
            <Table.Tr>
...
const AlertsSection: React.FC<{ flags: any[] } & SectionProps> = ({
  ...
  return (
    <Box>
      <SectionTitle title="Alerts" isSelected={isSelected} onSelectionChange={onSelectionChange} />
      <ResponsiveTable minWidth={900}>
        <Table>
          <Table.Tbody>
            <Table.Tr>
...
const PatientStorySection: React.FC<{ title: string; consents: any[] } & SectionProps> = ({
  ...
  return (
    <Box>
      <SectionTitle title={title} isSelected={isSelected} onSelectionChange={onSelectionChange} />
...
const FunctionalStatusSection: React.FC<{ conditions: any[] } & SectionProps> = ({
  ...
  return (
    <Box>
      <SectionTitle title="Functional Status" isSelected={isSelected} onSelectionChange={onSelectionChange} />
      <ResponsiveTable minWidth={900}>
        <Table>
          <Table.Tbody>
            <Table.Tr>
...
const PastProblemsSection: React.FC<{ conditions: any[] } & SectionProps> = ({
  ...
  return (
    <Box>
      <SectionTitle title="History of Past Problems" isSelected={isSelected} onSelectionChange={onSelectionChange} />
      <ResponsiveTable minWidth={900}>
        <Table>
          <Table.Tbody>
            <Table.Tr>
...
const PregnancyHistorySection: React.FC<{ pregnancyHistory: any[] } & SectionProps> = ({
  ...
  return (
    <Box>
      <SectionTitle title="History of Pregnancy" isSelected={isSelected} onSelectionChange={onSelectionChange} />
      <ResponsiveTable minWidth={700}>
        <Table>
          <Table.Tbody>
            <Table.Tr>
            ...
            {pregnancyHistory.map((preg: any, i: number) => (
              <Table.Tr key={`pregnancy-${i}`}>
                ...
                <Table.Td>
                  {preg.valueCodeableConcept?.text || preg.valueCodeableConcept?.coding?.[0]?.display}
                </Table.Td>
